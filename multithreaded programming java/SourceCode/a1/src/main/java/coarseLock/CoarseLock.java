...
public class CoarseLock implements Runnable {
	...
	public CoarseLock(HashMap<String,ArrayList<String>>accumulation,int start,int end,ArrayList<String> lines,Boolean fibflag) {
		super();
	...
	public void fib(int n)
	{
	  ...
	  *Here :The lock has been applied to the entire data structure
	  * 
	  * @param :none
	  * 
	  */
